...
CREATE TABLE LAB1_PERSON(
    ...
    FOREIGN KEY (EYE_COLOR) REFERENCES LAB1_COLOR(ID) ON DELETE CASCADE,
    FOREIGN KEY (HAIR_COLOR) REFERENCES LAB1_COLOR(ID) ON DELETE SET NULL,
    FOREIGN KEY (NATIONALITY_ID) REFERENCES LAB1_COUNTRY(ID) ON DELETE SET NULL
);
