...
import {fetchData} from '../util/apiQueries.ts'
import {makeQuerySelect } from '../util/baseMaps.ts';
import "../style/Table.css"
import type { SelectDTO } from '../interface/transfer-data/SelectDTO.ts';
import LocationTable from './table/LocationTable.tsx';
import type { TableData } from '../interface/TableData';
import type { Location } from "../interface/entity/Location.ts";
import DisciplineTable from './table/DisciplineTable.tsx';
import type { Discipline } from '../interface/entity/Discipline.ts';
import CoordinateTable from './table/CoordinateTable.tsx';
import type { Coordinate } from '../interface/entity/Coordinate.ts';
import type { Person } from '../interface/entity/Person.ts';
import PersonTable from './table/PersonTable.tsx';
import LabWorkTable from './table/LabWorkTable.tsx';
import type { LabWork } from '../interface/entity/LabWork.ts';
import BaseFrame from './frame/BaseFrame.tsx'
import CreateLocationSF from './frame/subframe/CreateLocationSF.tsx'
import CreateCoordinateSF from './frame/subframe/CreateCoordinateSF.tsx';
import CreateDisciplineSF from './frame/subframe/CreateDisciplineSF.tsx';
import CreatePersonSF from './frame/subframe/CreatePersonSF.tsx';
import CreateLabWorkSF from './frame/subframe/CreateLabWorkSF.tsx';
